...
celery_app.conf.beat_schedule = {
    ...
    "sync-calendar-every-15m": {
        "task": "app.tasks.calendar_sync.sync_calendar",
    ...
    "run-crawlers-every-4h": {
        "task": "app.tasks.content_generation.run_crawlers",
        "schedule": crontab(minute=0, hour="*/4"),
    },
    "daily-briefing-6am": {
        "task": "app.tasks.content_generation.daily_briefing",
        "schedule": crontab(minute=0, hour=6),
    },
    "generate-content-7am": {
        "task": "app.tasks.content_generation.generate_content",
